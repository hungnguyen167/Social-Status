...
it_occ == 11 ~ 00,3	Technicians and Associate Professionals
...
# both coding schemes are identical for Italy in 1987 & 1992 in terms of the order of values, just in 1992 the values thmeselves changed to starting with 1
socin <- socin %>%
  mutate(
    isco88_2digit = case_when(
