...
df <- dplyr::select(df, c(cntry, year, age, ageC, female, educyrs, degree, child, married, incZ, isei, egp, egp6, union, sparent, wrkhrs, wrkst, incdiff))
...
env93 <- dplyr::select(env93,c(cntry, year, age, ageC, female, educyrs, degree, child, married, incZ, isei, egp, egp6, union, sparent, wrkhrs, wrkst, incdiff))
...
# Select relevant variables 
env00 <- dplyr::select(env00,c(cntry, year, age, ageC, female, educyrs, degree, child, married, incZ, isei, egp, egp6, union, sparent, wrkhrs, wrkst, incdiff)) 
```
...
env10 <- dplyr::select(env10,c(cntry, year, age, ageC, female, educyrs, degree, child, married, incZ, isei, egp, egp6, union, sparent, wrkhrs, wrkst, incdiff))
```
