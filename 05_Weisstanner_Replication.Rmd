...
### Fig 6C Adjusted Predictions, Abs Low, Lib Low

```{r plot_fin_lo}
agg_png(here::here("weisstanner_replication","REPLICATION DATA","results","Fig6c.png"), width = 550, height = 425, res = 144)
df_rep_marg%>%
  ggplot() +
  #USA 
