...
j = ifelse(m %in% c(seq(from = 1, to = 100, by = 6)), "noconf_govZ",
  ...
  df_margins[m, "coef_lo95"] <-  df_margins[m, "coef_delta"] - (1.96*(df_margins[m, "coef_se"] ))
  df_margins[m, "coef_hi95"] <-  df_margins[m, "coef_delta"] + (1.96*(df_margins[m, "coef_se"]))
...
################# Ignore this code, its for reminder
#+ 
