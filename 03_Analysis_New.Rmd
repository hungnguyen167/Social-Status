...
M2.01 <- lmer(gov_redist ~ incdiff_large + noconf_govZ + (1 | iso3c) + (1 | wave), data = df_na)

M2.02 <- lmer(gov_redist ~ incdiff_large + cpiZ + (1 | iso3c) + (1 | wave), data = df_na)

M2.03 <- lmer(gov_redist ~ incdiff_large + libZ + (1 | iso3c) + (1 | wave), data = df_na)

## Imputed ("i")

M2.04i <- lmer(gov_redist ~ incdiff_large + noconf_govZ_i + (1 | iso3c) + (1 | wave), data = df_na)

M2.05i <- lmer(gov_redist ~ incdiff_large + cpiZ_i + (1 | iso3c) + (1 | wave), data = df_na)

M2.06i <- lmer(gov_redist ~ incdiff_large + libZ_i + (1 | iso3c) + (1 | wave), data = df_na)

## Original within/between
M2.07wb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + noconf_govZ + (1 | iso3c) + (1 | wave), data = df_na)

M2.08wb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + cpiZ + (1 | iso3c) + (1 | wave), data = df_na)

M2.09wb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + libZ + (1 | iso3c) + (1 | wave), data = df_na)

## Imputed within/between

M2.10iwb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + noconf_govZ_i + (1 | iso3c) + (1 | wave), data = df_na)

M2.11iwb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + cpiZ_i + (1 | iso3c) + (1 | wave), data = df_na)

M2.12iwb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + libZ_i + (1 | iso3c) + (1 | wave), data = df_na)

# random-slope for incdiff_large by country
M3.01 <- lmer(gov_redist ~ incdiff_large + noconf_govZ + (incdiff_large | iso3c) + (1 | wave), data = df_na)

M3.02 <- lmer(gov_redist ~ incdiff_large + cpiZ + (incdiff_large | iso3c) + (1 | wave), data = df_na)

M3.03 <- lmer(gov_redist ~ incdiff_large + libZ + (incdiff_large | iso3c) + (1 | wave), data = df_na)

M3.04i <- lmer(gov_redist ~ incdiff_large + noconf_govZ_i + (incdiff_large | iso3c) + (1 | wave), data = df_na)

M3.05i <- lmer(gov_redist ~ incdiff_large + cpiZ_i + (incdiff_large | iso3c) + (1 | wave), data = df_na)

M3.05i <- lmer(gov_redist ~ incdiff_large + libZ_i + (incdiff_large | iso3c) + (1 | wave), data = df_na)

M3.07wb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + noconf_govZ + (incdiff_large_w | iso3c) + (1 | wave), data = df_na)

M3.08wb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + cpiZ + (incdiff_large_w | iso3c) + (1 | wave), data = df_na)

M3.09wb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + libZ + (incdiff_large_w | iso3c) + (1 | wave), data = df_na)

M3.10iwb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + noconf_govZ_i + (incdiff_large_w | iso3c) + (1 | wave), data = df_na)

M3.11iwb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + cpiZ_i + (incdiff_large_w | iso3c) + (1 | wave), data = df_na)

M3.12iwb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + libZ_i + (incdiff_large_w | iso3c) + (1 | wave), data = df_na)

# interaction models for plotting
M_4.01 <- lmer(gov_redist ~ incdiff_large + noconf_govZ + noconf_govZ*incdiff_large + (1 | iso3c) + (1 | wave), data = df_na)

M_4.02 <- lmer(gov_redist ~ incdiff_large + cpiZ + cpiZ*incdiff_large + (1 | iso3c) + (1 | wave), data = df_na)

M_4.03 <- lmer(gov_redist ~ incdiff_large + libZ + libZ*incdiff_large + (1 | iso3c) + (1 | wave), data = df_na)

M_4.04i <- lmer(gov_redist ~ incdiff_large + noconf_govZ_i + noconf_govZ_i*incdiff_large + (1 | iso3c) + (1 | wave), data = df_na)

M_4.05i <- lmer(gov_redist ~ incdiff_large + cpiZ_i + cpiZ_i*incdiff_large + (1 | iso3c) + (1 | wave), data = df_na)

M_4.06i <- lmer(gov_redist ~ incdiff_large + libZ_i + libZ_i*incdiff_large + (1 | iso3c) + (1 | wave), data = df_na)

M_4.07wb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + noconf_govZ + noconf_govZ*incdiff_large_w + (1 | iso3c) + (1 | wave), data = df_na)

M_4.08wb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + cpiZ + cpiZ*incdiff_large_w + (1 | iso3c) + (1 | wave), data = df_na)

M_4.09wb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + libZ + libZ*incdiff_large_w + (1 | iso3c) + (1 | wave), data = df_na)

M_4.10iwb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + noconf_govZ_i + noconf_govZ_i*incdiff_large_w + (1 | iso3c) + (1 | wave), data = df_na)

M_4.11iwb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + cpiZ_i + cpiZ_i*incdiff_large_w + (1 | iso3c) + (1 | wave), data = df_na)

M_4.12iwb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + libZ_i + libZ_i*incdiff_large_w + (1 | iso3c) + (1 | wave), data = df_na)

### socx control

M_5.01 <- lmer(gov_redist ~ incdiff_large + noconf_govZ + noconf_govZ*incdiff_large + socx + (1 | iso3c) + (1 | wave), data = df_na)

M_5.02 <- lmer(gov_redist ~ incdiff_large + cpiZ + cpiZ*incdiff_large + socx + (1 | iso3c) + (1 | wave), data = df_na)

M_5.03 <- lmer(gov_redist ~ incdiff_large + libZ + libZ*incdiff_large + socx + (1 | iso3c) + (1 | wave), data = df_na)

M_5.04i <- lmer(gov_redist ~ incdiff_large + noconf_govZ_i + noconf_govZ_i*incdiff_large + socx + (1 | iso3c) + (1 | wave), data = df_na)

M_5.05i <- lmer(gov_redist ~ incdiff_large + cpiZ_i + cpiZ_i*incdiff_large + socx + (1 | iso3c) + (1 | wave), data = df_na)

M_5.06i <- lmer(gov_redist ~ incdiff_large + libZ_i + libZ_i*incdiff_large + socx + (1 | iso3c) + (1 | wave), data = df_na)

M_5.07wb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + noconf_govZ + noconf_govZ*incdiff_large_w + socx + (1 | iso3c) + (1 | wave), data = df_na)

M_5.08wb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + cpiZ + cpiZ*incdiff_large_w + socx + (1 | iso3c) + (1 | wave), data = df_na)

M_5.09wb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + libZ + libZ*incdiff_large_w + socx + (1 | iso3c) + (1 | wave), data = df_na)

M_5.10iwb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + noconf_govZ_i + noconf_govZ_i*incdiff_large_w + socx + (1 | iso3c) + (1 | wave), data = df_na)

M_5.11iwb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + cpiZ_i + cpiZ_i*incdiff_large_w + socx + (1 | iso3c) + (1 | wave), data = df_na)

M_5.12iwb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + libZ_i + libZ_i*incdiff_large_w + socx + (1 | iso3c) + (1 | wave), data = df_na)

## gini

M_6.01 <- lmer(gov_redist ~ incdiff_large + noconf_govZ + noconf_govZ*incdiff_large + gini_disp + (1 | iso3c) + (1 | wave), data = df_na)

M_6.02 <- lmer(gov_redist ~ incdiff_large + cpiZ + cpiZ*incdiff_large + gini_disp + (1 | iso3c) + (1 | wave), data = df_na)

M_6.03 <- lmer(gov_redist ~ incdiff_large + libZ + libZ*incdiff_large + gini_disp + (1 | iso3c) + (1 | wave), data = df_na)

M_6.04i <- lmer(gov_redist ~ incdiff_large + noconf_govZ_i + noconf_govZ_i*incdiff_large + gini_disp + (1 | iso3c) + (1 | wave), data = df_na)

M_6.05i <- lmer(gov_redist ~ incdiff_large + cpiZ_i + cpiZ_i*incdiff_large + gini_disp + (1 | iso3c) + (1 | wave), data = df_na)

M_6.06i <- lmer(gov_redist ~ incdiff_large + libZ_i + libZ_i*incdiff_large + gini_disp + (1 | iso3c) + (1 | wave), data = df_na)

M_6.07wb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + noconf_govZ + noconf_govZ*incdiff_large_w + gini_disp + (1 | iso3c) + (1 | wave), data = df_na)

M_6.08wb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + cpiZ + cpiZ*incdiff_large_w + gini_disp + (1 | iso3c) + (1 | wave), data = df_na)

M_6.09wb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + libZ + libZ*incdiff_large_w + gini_disp + (1 | iso3c) + (1 | wave), data = df_na)

M_6.10iwb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + noconf_govZ_i + noconf_govZ_i*incdiff_large_w + gini_disp + (1 | iso3c) + (1 | wave), data = df_na)

M_6.11iwb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + cpiZ_i + cpiZ_i*incdiff_large_w + gini_disp + (1 | iso3c) + (1 | wave), data = df_na)

M_6.12iwb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + libZ_i + libZ_i*incdiff_large_w + gini_disp + (1 | iso3c) + (1 | wave), data = df_na)

# gdp

M_7.01 <- lmer(gov_redist ~ incdiff_large + noconf_govZ + noconf_govZ*incdiff_large + gdp_pc_10k + (1 | iso3c) + (1 | wave), data = df_na)

M_7.02 <- lmer(gov_redist ~ incdiff_large + cpiZ + cpiZ*incdiff_large + gdp_pc_10k + (1 | iso3c) + (1 | wave), data = df_na)

M_7.03 <- lmer(gov_redist ~ incdiff_large + libZ + libZ*incdiff_large + gdp_pc_10k + (1 | iso3c) + (1 | wave), data = df_na)

M_7.04i <- lmer(gov_redist ~ incdiff_large + noconf_govZ_i + noconf_govZ_i*incdiff_large + gdp_pc_10k + (1 | iso3c) + (1 | wave), data = df_na)

M_7.05i <- lmer(gov_redist ~ incdiff_large + cpiZ_i + cpiZ_i*incdiff_large + gdp_pc_10k + (1 | iso3c) + (1 | wave), data = df_na)

M_7.06i <- lmer(gov_redist ~ incdiff_large + libZ_i + libZ_i*incdiff_large + gdp_pc_10k + (1 | iso3c) + (1 | wave), data = df_na)

M_7.07wb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + noconf_govZ + noconf_govZ*incdiff_large_w + gdp_pc_10k + (1 | iso3c) + (1 | wave), data = df_na)

M_7.08wb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + cpiZ + cpiZ*incdiff_large_w + gdp_pc_10k + (1 | iso3c) + (1 | wave), data = df_na)

M_7.09wb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + libZ + libZ*incdiff_large_w + gdp_pc_10k + (1 | iso3c) + (1 | wave), data = df_na)

M_7.10iwb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + noconf_govZ_i + noconf_govZ_i*incdiff_large_w + gdp_pc_10k + (1 | iso3c) + (1 | wave), data = df_na)

M_7.11iwb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + cpiZ_i + cpiZ_i*incdiff_large_w + gdp_pc_10k + (1 | iso3c) + (1 | wave), data = df_na)

M_7.12iwb <- lmer(gov_redist ~ incdiff_large_b + incdiff_large_w + libZ_i + libZ_i*incdiff_large_w + gdp_pc_10k + (1 | iso3c) + (1 | wave), data = df_na)
...
# margins command takes too long, although it gives AMEs, but we don't need them here
