...
B. Finish recodes in 2019 data, this means remove missing data (e.g., degree), add income, add egp (fix supervision and n.employees variables)
...
pacman::p_load("tidyverse","knitr","haven","car","plyr","dplyr", "e1071","stargazer","lavaan","kableExtra","MASS","glm.predict","brant", "semTools", "tidylog", "countrycode", "Hmisc", "ineq")
...
# fix later
  ...
  select(incdiff,cntry, year, wave, female, ageC, age, married, educyrs, union, wrkst, isco08, degree)
# integrate hhcycle from socin2 (US92)
...
```
>>>>>>> 3230780e5011dccda5292229d8d3379eb65c0c69:Social Status - Data Cleaning.Rmd

### Merge

<<<<<<< HEAD:01_Data Cleaning.Rmd
## Income
# Is coded in local currency and this really skews the standardization process. Recode into local deciles
...
df$inclarge <- ifelse(df$inclarge == 9, NA, df$inclarge)
