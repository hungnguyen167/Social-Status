...
#new plot
df_tbl %>%
ggplot(aes(x = incdiff_large_agree , y = gap_no_gov, color = corr)) + 
  geom_point( 
             alpha = 0.75, 
             size=4) + 
  geom_text(label=df_tbl$iso3c, 
             position = "dodge",
             vjust=0.3, hjust=-0.2)+
  ...
  theme_minimal() + theme(legend.position = "right") +
    scale_color_gradient2(midpoint=mid, low="#29AF7FFF", mid="gray55", high="#440154FF", space="Lab") +
...
```
## Fig 2. Main. Correlation of Redist Variables and Context Vars
