...
tbl1[2:22,7] <- c("ISSP", "ISSP", "IVS", "IVS", "IVS", "IVS", "IVS", "IVS", "CPI", "CPI", "V-Dem", "OECD", "World Bank", "Solt (2020)", "", "", "ISSP", "ISSP", "ISSP", "ISSP", "ISSP")
...
agg_png(filename = here::here("results","statt_plot.png"), width = 1200, height = 1200, res = 144)
...
knitr::include_graphics(here::here("results", "statt_plot.png"))
```
...
```{r fig2}
agg_png(filename = here::here("results","Fig4.png"), res = 144, width = 2000, height = 800)
ggarrange(Fig2.1, Fig2.1_redist, Fig2.3, widths = c(1.1,1,1.1), nrow = 1)
dev.off()
...
```{r fig3}
agg_png(filename = here::here("results","Fig5.png"), res = 144, width = 1300, height = 800) +
  theme(text = element_text())
ggarrange(Fig2.2, Fig2.4, widths = c(1,1.15))
dev.off()
