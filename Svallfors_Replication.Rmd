...
pacman::p_load("tidyverse","knitr","haven","car","plyr","data.table","expss","htmlTable","magrittr","ltm","questionr","survey","remotes","stargazer")
...
table4<- stargazer(m1nor, m1ger, m1aus, m1usa, title= "Table 4",type = "text", apply.se = function(x) {0}, single.row = TRUE)
