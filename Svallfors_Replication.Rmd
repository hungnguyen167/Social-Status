...
socIn92new <- socIn92new[,c("V3","ISCO88","V5")]


socIn92new <- dplyr::rename(socIn92new, v2 = V3)
socIn92recode$V5 <- car::recode(socIn92recode$v3, recodes = '10 = 752; 1 = 36; 2 = 276; 9 = 578; 6 = 40; 16 = 554; 17 = 124; 5= 840')


newdata <- as.data.frame(left_join(socIn92recode, socIn92new, by = "v2"))

newdata$self <- car::recode(newdata$v110, recodes = '2=0')

#newdata[which(newdata$v3 == 10),]$v108 <- car::recode(newdata[which(newdata$v3 == 10),]$v108, recodes = 'NA = 0')

newdata$sup <- ifelse(newdata$v3 == 10, 0, newdata$v108)



newdata$egp <- occupar::isco88toEGP(newdata$ISCO88, self.employed = newdata$self,n.employees = newdata$sup)
...
summary(newdata[which(newdata$v3 == 10),]$ISCO88)
