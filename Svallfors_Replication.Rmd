...
```{r}
setwd("C:/GitHub/Svallfors-1997-Replication")
lca <- MplusAutomation::extractModelSummaries(target = getwd("svallfors1lcac2.out"))
```


Let's say Svallfors assumed that his 3 category collapse was 'right'. We can test this by predicting
...
Information Criteria
          ...
          Akaike (AIC)                   88734.962
          Bayesian (BIC)                 88806.957
          Sample-Size Adjusted BIC       88775.178
...
Information Criteria
          ...
          Akaike (AIC)                   87575.880
          Bayesian (BIC)                 87676.673
          Sample-Size Adjusted BIC       87632.183
...
Loglikelihood
          ...
          H0 Value                      -42770.138
          H0 Scaling Correction Factor      1.0992
            for MLR

Information Criteria

          Akaike (AIC)                   85576.275
          Bayesian (BIC)                 85705.866
          Sample-Size Adjusted BIC       85648.665
...
Loglikelihood
          ...
          H0 Value                      -42107.759
          H0 Scaling Correction Factor      1.1210
            for MLR

Information Criteria

          Akaike (AIC)                   84259.517
          Bayesian (BIC)                 84417.906
          Sample-Size Adjusted BIC       84347.993
