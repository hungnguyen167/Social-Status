...
## Guide to Mplus models by name

These are the two models, they produce good loadings. But they cannot be compared because the underlying data are different between the models

# svallfors.inp = CFA, jobs incd basic (the 'typical' model)
# svallfors1.inp = CFA, jobs3 incd3 basic3 (Svallfors' model)
