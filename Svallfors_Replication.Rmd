...
library(pacman)
library(ltm)
pacman::p_load("tidyverse","knitr","haven","car","plyr","data.table","expss","htmlTable","magrittr","ltm","questionr")
...
#Hung: Creating table 1 using weighted.mean()
...
#Compare with Svallfors'. Disappointing results though :(
table1diff2 <- round(table1.2 - table1Sval,2)
...
```{r}
#Now we want to compare our results with the results of Svallfors 
