---
title: "Data Cleaning 1. Individual-Level"
output:
  html_document:
    df_print: paged
---
...
be09 <- socin09 %>%
  ...
  select(cntry, year, wave, age, ageC, female, educyrs, degree, child, married, rincZ, hincZ, rincO, isei, egp, egp6, f_egp, f_egp6, f_isei, m_egp, m_egp6, m_isei, union, sparent, wrkhrs, wrkst, incdiff, inclarge, corrupt_top, isco88, isco88_2digit, fisco88_2digit, misco88_2digit, spisco88_2digit)
