...
```{r tbl2, echo = T}
tab2 <- dplyr::as.tbl(dplyr::select(df, year, ageC, female, educyrs, degree, child, married, incZ, hincZ, isei, egp, egp6, union, sparent, wrkhrs, wrkst, reduce))
...
tab2 <- dplyr::select(tab2, year, ageC, female, educyrs, child, married, incZ, hincZ, isei, egp_un, egp_skl, egp_othr, egp_rou, egp_svc2, egp_svc1, wk_full:wk_other, wrkhrs, union, sparent, reduce)
# Get summary stats
