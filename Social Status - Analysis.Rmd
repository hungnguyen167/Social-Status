...
## 'Playing' Around with Groups/Visualizations
...
linearHypothesis(m1, c(paste0("groups2 =", reduce_test), paste0("groups4 =", reduce_test)))
...
m3 <- 'reduce ~ a*group1 + a*group2 + a*group3'
