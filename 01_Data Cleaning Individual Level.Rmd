---
title: "1. Data-Cleaning Individual-Level"
output:
  html_document:
    df_print: paged
---
...
We worked up many more individual level variables as this code is used in multiple projects. We leave it here as it is, in case users find it useful. 

## ISSP Data

Social Inequality, Cumulation (1987, 1992, 1999, 2009 & 2009)
Social Inequality, 2019
Environment Module code left in file, but not used in this paper as it is missing key variables
...
pacman::p_load("tidyverse","occupar","isco88conversion","haven","car","plyr","e1071","MASS","brant","countrycode", "Hmisc", "ineq", "report")
...
socin <- dplyr::select(socin, cntry, year, wave, age, ageC, female, educyrs, degree, child, married, rincZ, hincZ, rincO, isei, egp, egp6, f_egp, f_egp6, f_isei, m_egp, m_egp6, m_isei, union, sparent, wrkhrs, wrkst, incdiff, inclarge, corrupt_top, isco88, isco88_2digit, fisco88_2digit, misco88_2digit, spisco88_2digit)
...
#   
# 
 nl87 <- dplyr::select(nl87, cntry, year, wave, age, ageC, female, educyrs, degree, child, married, rincZ, hincZ, isei, egp, egp6, f_egp, f_egp6, f_isei, m_egp, m_egp6, m_isei, union, sparent, wrkhrs, wrkst, incdiff, inclarge, corrupt_top, isco88, isco88_2digit, fisco88_2digit, misco88_2digit, spisco88_2digit)
...
# 
# 
 ie87 <- dplyr::select(ie87, cntry, year, wave, age, ageC, female, educyrs, degree, child, married, rincZ, hincZ, isei, egp, egp6, f_egp, f_egp6, f_isei, m_egp, m_egp6, m_isei, union, sparent, wrkhrs, wrkst, incdiff, inclarge, corrupt_top, isco88, isco88_2digit, fisco88_2digit, misco88_2digit, spisco88_2digit)
...
dk99 <- dplyr::select(dk99, cntry, year, wave, age, ageC, female, educyrs, degree, child, married, rincZ, hincZ, rincO, isei, egp, egp6, f_egp, f_egp6, f_isei, m_egp, m_egp6, m_isei, union, sparent, wrkhrs, wrkst, incdiff, inclarge, corrupt_top, isco88, isco88_2digit, fisco88_2digit, misco88_2digit,spisco88_2digit)
...
ie99 <- dplyr::select(ie99, cntry, year, wave, age, ageC, female, educyrs, degree, child, married, rincZ, hincZ, rincO, isei, egp, egp6, f_egp, f_egp6, f_isei, m_egp, m_egp6, m_isei, union, sparent, wrkhrs, wrkst, incdiff, inclarge, corrupt_top, isco88, isco88_2digit, fisco88_2digit, misco88_2digit, spisco88_2digit)
...
nl09 <- dplyr::select(nl09, cntry, year, wave, age, ageC, female, educyrs, degree, child, married, rincZ, hincZ, rincO, isei, egp, egp6, f_egp, f_egp6, f_isei, m_egp, m_egp6, m_isei, union, sparent, wrkhrs, wrkst, incdiff, inclarge, corrupt_top, isco88, isco88_2digit, fisco88_2digit, misco88_2digit, spisco88_2digit)
...
ca09 <- dplyr::select(ca09, cntry, year, wave, age, ageC, female, educyrs, degree, child, married, rincZ, hincZ, rincO, isei, egp, egp6, f_egp, f_egp6, f_isei, m_egp, m_egp6, m_isei, union, sparent, wrkhrs, wrkst, incdiff, inclarge, corrupt_top, isco88, isco88_2digit, fisco88_2digit, misco88_2digit, spisco88_2digit)
...
nl99 <- dplyr::select(nl99, cntry, year, wave, age, ageC, female, educyrs, degree, child, married, rincZ, hincZ, rincO, isei, egp, egp6, f_egp, f_egp6, f_isei, m_egp, m_egp6, m_isei, union, sparent, wrkhrs, wrkst, incdiff, inclarge, corrupt_top, isco88, isco88_2digit, fisco88_2digit, misco88_2digit, spisco88_2digit)
...
be09 <- socin09 %>%
  ...
  dplyr::select(cntry, year, wave, age, ageC, female, educyrs, degree, child, married, rincZ, hincZ, rincO, isei, egp, egp6, f_egp, f_egp6, f_isei, m_egp, m_egp6, m_isei, union, sparent, wrkhrs, wrkst, incdiff, inclarge, corrupt_top, isco88, isco88_2digit, fisco88_2digit, misco88_2digit, spisco88_2digit)
...
# Select relevant variables 
socin3 <- dplyr::select(socin3,c(cntry, year, wave, age, ageC, female, educyrs, degree, child, married, rincZ, hincZ, rincO, isei, egp, egp6, f_egp, f_egp6, f_isei, m_egp, m_egp6, m_isei, union, sparent, wrkhrs, wrkst, incdiff, inclarge, corrupt_top, isco88, isco88_2digit, fisco88_2digit, misco88_2digit, spisco88_2digit))
...
df <- df %>%
  ...
  dplyr::select(year, wave, country, iso3c, cntry, everything())
