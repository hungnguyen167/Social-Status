...
df_macro <- df_macro %>%
  mutate(liberal_high = ifelse(iso3c %in% rich_countries, liberal, NA), 
         ...
         liberal_low = ifelse(iso3c %in% c("SVN","CZE","CYP","ESP","PRT"), NA, liberal_low), # remove some questionable mid-GDP cases
         liberal_high_i = ifelse(iso3c %in% rich_countries, liberal_i, NA), 
         liberal_low_i = ifelse(is.na(liberal_high), liberal_i, NA),
         liberal_low_i = ifelse(iso3c %in% c("SVN","CZE","CYP","ESP","PRT"), NA, liberal_low_i),
