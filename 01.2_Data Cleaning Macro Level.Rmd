...
df_macro <- df_macro %>%
  mutate(liberal_high = ifelse(iso3c %in% rich_countries, liberal, NA), 
         ...
         liberal_redist_low = ifelse(iso3c %in% c("SVN","CZE","CYP","ESP","PRT"), NA, liberal_redist_low), # remove some questionable mid-GDP cases
         ...
         liberal_redist_low_i = ifelse(iso3c %in% c("SVN","CZE","CYP","ESP","PRT"), NA, liberal_redist_low_i),
