...
# lavaan automatically tests the model with and without the fixed parameter 
...
m0_lib_fit <- sem(m0_lib, data = df_na_libZ, cluster = "iso3c_wave")
m1_lib_fit <- sem(m1_lib, data = df_na_libZ, cluster = "iso3c_wave")
