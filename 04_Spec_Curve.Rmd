...
fig4 <- df_ame_mod %>%
  ...
  annotate(geom = "text", x = 56, y = 0.12, label = "Liberal Values\nhigh abstraction", color = "#73D055FF") +
  annotate(geom = "text", x = 168, y = 0.12, label = "Lack of Trust\nmedium abstraction", color = "#287D8EFF") +
  annotate(geom = "text", x = 280, y = 0.12, label = "Corruption Perceptions\nlow abstraction", color = "#453781FF") +
  theme_classic() +
    theme(
